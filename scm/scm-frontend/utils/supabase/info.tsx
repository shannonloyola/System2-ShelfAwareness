...
const FALLBACKS = {
  ...
  authUserAccessServiceUrl: "http://localhost:3026",
} as const;
...
export const publicAnonKey =
  trimValue(process.env.NEXT_PUBLIC_SCM_FRONTEND_SUPABASE_ANON_KEY) ||
  FALLBACKS.identityAnonKey;

export const scmSupabaseUrl = readUrl(
  process.env.NEXT_PUBLIC_SCM_FRONTEND_SUPABASE_SUPPLY_CHAIN_URL,
  FALLBACKS.scmUrl,
);
export const scmPublicAnonKey =
  trimValue(process.env.NEXT_PUBLIC_SCM_FRONTEND_SUPABASE_SUPPLY_CHAIN_ANON_KEY) ||
  FALLBACKS.scmAnonKey;

export const fulfillmentSupabaseUrl = readUrl(
  process.env.NEXT_PUBLIC_SCM_FRONTEND_SUPABASE_FULFILLMENT_URL,
  FALLBACKS.fulfillmentUrl,
);
export const fulfillmentPublicAnonKey =
  trimValue(process.env.NEXT_PUBLIC_SCM_FRONTEND_SUPABASE_FULFILLMENT_ANON_KEY) ||
  FALLBACKS.fulfillmentAnonKey;

export const qualitySupabaseUrl = readUrl(
  process.env.NEXT_PUBLIC_SCM_FRONTEND_SUPABASE_QUALITY_URL,
  FALLBACKS.qualityUrl,
);
export const qualityPublicAnonKey =
  trimValue(process.env.NEXT_PUBLIC_SCM_FRONTEND_SUPABASE_QUALITY_ANON_KEY) ||
  FALLBACKS.qualityAnonKey;

export const supportIntelSupabaseUrl = readUrl(
  process.env.NEXT_PUBLIC_SCM_FRONTEND_SUPABASE_SUPPORT_INTEL_URL,
  FALLBACKS.supportIntelUrl,
);
export const supportIntelPublicAnonKey =
  trimValue(process.env.NEXT_PUBLIC_SCM_FRONTEND_SUPABASE_SUPPORT_INTEL_ANON_KEY) ||
  FALLBACKS.supportIntelAnonKey;

export const authUserAccessServiceUrl = readUrl(
  process.env.NEXT_PUBLIC_SCM_FRONTEND_AUTH_USER_ACCESS_SERVICE_URL,
